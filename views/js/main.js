       ...
       /*=============================================
        ...
        if(methodPaid == "mercado-pago"){
            ...
            $.ajax(settings).done(function (response) {
                ...
                const mercadopago = new MercadoPago('TEST-1b48633c-6600-4d9b-afb6-60652e431db9');
        ...
        if(resp){
            ...
            $.ajax({
                ...
                success: function (respose){
                    ...
                    var settings = {
                        "url": $("http://api-marketplace.com/").val()+"products?id="+idProduct+"&nameId=id_product&token="+localStorage.getItem("token_user"),
                        "method": "DELETE",
                        "timeout": 0,
                        "headers": {
                            "Content-Type": "application/x-www-form-urlencoded"
